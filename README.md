...
3. The page is optimized to work best on mobile (width ≤ 480px)
...
1. Change the event date in the JavaScript for the countdown timer
2. Replace placeholder images in the `/assets` folder
3. Change colors in the CSS variables
4. Update content in the HTML files
